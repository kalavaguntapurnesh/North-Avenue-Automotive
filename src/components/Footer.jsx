          ...
          <div className="pb-8 mb-8 border-b border-gray-400">
            <div className="grid grid-cols-2 md:grid-cols-5 ">
              <div className="mb-12 md:mb-0 ">
                ...
                <ul className="pl-0 mt-4 space-y-3 list-none text-gray-600">
                  <li className=" flex items-center justify-center">
                    <a
                      href="/"
                      className="no-underline text-[14px] leading-6  transition duration-1000 ease-in-out"
                    >
                      Customer Success
                    </a>
                  </li>
                ...
                <form action="">
                  <div className="mt-4 flex flex-col justify-center items-center">
                    ...
                    <div className="mt-4 mb-2 rounded-md flex w-full justify-center items-center">
                      <button
                        type="submit"
                        className="md:w-9/12 w-10/12 flex items-center justify-center px-5 py-3 text-base leading-6 font-medium rounded-md text-white bg-colorTwo hover:bg-colorFour focus:outline-none focus:bg-green-200 transition duration-1000 ease-in-out"
                      >
                        Subscribe
                      </button>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex justify-center items-center">
              <p className="md:text-sm text-xs text-gray-600">
                Copyright © 2024 N.Avenue. All rights reserved.
              </p>
            </div>
          </div>
        </div>
